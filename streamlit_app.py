...
def main():
    ...
    <div class="main-header">
        ...
        <p>Thai Food Nutrition Analyzer - เวอร์ชันพัฒนาขึ้น</p>
    </div>
    """, unsafe_allow_html=True)
    ...
    with st.sidebar:
        ...
        search_mode = st.selectbox(
            "โหมดการค้นหา",
            ["อัตโนมัติ", "Semantic Search เท่านั้น", "Fuzzy Search เท่านั้น"],
            help="อัตโนมัติ = ใช้ทั้ง Semantic และ Fuzzy"
        )
        ...
        if model:
            ...
            st.warning("⚠️ โมเดล AI ไม่พร้อม")
    ...
    with tab3:
        ...
        with col1:
            ...
            - **AI Search**: Sentence Transformers
            - **โมเดล**: paraphrase-multilingual-MiniLM-L12-v2
            - **การค้นหา**: Semantic + Fuzzy Matching
            - **UI Framework**: Streamlit
            - **ข้อมูล**: สูตรอาหารไทยรวบรวม
            
            ### 🎯 คุณสมบัติหลัก
            
            - ค้นหาอาหารด้วย AI ที่เข้าใจภาษาไทย
            - รองรับการพิมพ์ผิด
        ...
        with col2:
            ...
            - **จำนวนสูตรอาหาร**: """ + str(len(data)) + """ รายการ
